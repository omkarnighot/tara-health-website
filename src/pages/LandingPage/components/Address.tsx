...
const Address = () => {
    return (
        <Box className="flex flex-col md:flex-row justify-center items-center my-20 w-full h-[50vh] px-5">
            ...
            <Box className="flex justify-center p-5 md:w-1/2 rounded-2xl">
                <iframe
